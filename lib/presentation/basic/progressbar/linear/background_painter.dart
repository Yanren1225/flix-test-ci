...
class BackgroundPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawRect(Rect.fromPoints(Offset.zero, Offset(size.width, size.height)), paint);
    // canvas.drawRRect(
  ...
  @override
  bool shouldRepaint(covariant BackgroundPainter oldDelegate) => backgroundColor != oldDelegate.backgroundColor;
}
