...
class IntroAgreementPage extends StatefulWidget {
  const IntroAgreementPage({Key? key}) : super(key: key);

  @override
  _IntroAgreementPageState createState() => _IntroAgreementPageState();
}

class _IntroAgreementPageState extends State<IntroAgreementPage> {
  @override
  void initState() {
    super.initState();
  }
  ...
  void _initSystemChrome() {
    SystemChrome.setSystemUIOverlayStyle(
      SystemUiOverlayStyle(
        statusBarColor: Theme.of(context).flixColors.background.secondary,
