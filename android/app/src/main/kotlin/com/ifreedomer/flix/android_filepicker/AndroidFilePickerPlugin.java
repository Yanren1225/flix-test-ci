...
public class AndroidFilePickerPlugin implements MethodChannel.MethodCallHandler, FlutterPlugin, ActivityAware {

    private static final String TAG = "FilePicker";
    private static final String CHANNEL = "com.ifreedomer.flix.plugins.android_filepicker";
    private static final String EVENT_CHANNEL = "com.ifreedomer.flix.plugins.android_filepickerevent";
    ...
    private AndroidFilePickerDelegate delegate;
    ...
    public static void registerWith(final PluginRegistry.Registrar registrar) {
        ...
        final AndroidFilePickerPlugin plugin = new AndroidFilePickerPlugin();
    ...
    public void onMethodCall(final MethodCall call, final MethodChannel.Result rawResult) {
        ...
        fileType = AndroidFilePickerPlugin.resolveType(call.method);
    ...
    private void setup(
        ...
        this.delegate = new AndroidFilePickerDelegate(activity);
