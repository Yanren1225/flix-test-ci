...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1119973538;
...
abstract class RustLibApi extends BaseApi {
  Future<Uint8List> crateImageCompressImageCompressContain(
  ...
  Future<Uint8List> crateImageCompressImageCompressFitHeight(
      {required String pathStr,
      CompressFormat? compressFormat,
      int? maxHeight,
      int? quality,
  ...
  Future<Uint8List> crateImageCompressImageCompressFitWidth(
      {required String pathStr,
      CompressFormat? compressFormat,
      int? maxWidth,
      int? quality,
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<Uint8List> crateImageCompressImageCompressContain(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateImageCompressImageCompressContainConstMeta,
      argValues: [
        pathStr,
        compressFormat,
        maxWidth,
  ...
  TaskConstMeta get kCrateImageCompressImageCompressContainConstMeta =>
      const TaskConstMeta(
        debugName: "contain",
        argNames: [
          "pathStr",
  ...
  Future<Uint8List> crateImageCompressImageCompressFitHeight(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateImageCompressImageCompressFitHeightConstMeta,
      argValues: [pathStr, compressFormat, maxHeight, quality, samplingFilter],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateImageCompressImageCompressFitHeightConstMeta =>
      const TaskConstMeta(
  ...
  Future<Uint8List> crateImageCompressImageCompressFitWidth(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateImageCompressImageCompressFitWidthConstMeta,
      argValues: [pathStr, compressFormat, maxWidth, quality, samplingFilter],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateImageCompressImageCompressFitWidthConstMeta =>
      const TaskConstMeta(
        debugName: "fit_width",
        argNames: [
          "pathStr",
